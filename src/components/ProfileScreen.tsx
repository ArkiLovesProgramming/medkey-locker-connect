  ...
  return (
    <div className="pb-24 px-5 pt-6">
      ...
      <div className="flex flex-col items-center mb-5">
        <div className="w-20 h-20 rounded-full bg-teal-light flex items-center justify-center border-2 border-border mb-3">
      ...
      {/* Premium Banner */}
      <div className="bg-amber/15 border border-amber/25 rounded-2xl px-4 py-3.5 flex items-center gap-3 mb-6">
                ...
                >
                  <item.icon
                    className={`w-5 h-5 flex-shrink-0 ${
                      item.danger ? "text-destructive" : "text-teal-dark"
                    }`}
                  />
                  <span
