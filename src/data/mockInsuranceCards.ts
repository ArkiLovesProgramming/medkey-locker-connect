...
export const insuranceCards: InsuranceCard[] = [
  ...
  // Fix 2: Adding insurance cards for Margaret and Robert
  {
    id: 'insurance-004',
    memberId: 'user-005',
    ...
    memberIdNumber: 'AET456789012',
    groupNumber: 'GRP-556677',
    cardholderGroupId: 'CG-654321',
    coverageType: 'primary',
    status: 'active',
    effectiveDate: '2024-01-01',
    expirationDate: '2026-12-31',
  ...
  },
  {
    ...
    memberIdNumber: 'UHC789012345',
    groupNumber: 'GRP-889900',
    cardholderGroupId: 'CG-112233',
    coverageType: 'primary',
    status: 'active',
    effectiveDate: '2024-01-01',
    expirationDate: '2026-12-31',
