...
export const prescriptions: Prescription[] = [
  ...
  },
  {
    ...
    quantity: 30,
    dosage: '10mg',
    frequency: 'Take one tablet daily as needed',
    status: 'needs-approval',
    patientId: 'user-001',
      ...
      coverageItems: [
        {
          ...
          amount: 0.00,
          isDenied: true,
          denialReason: 'DIN not covered',
          denialDetails: 'This medication (Drug Identification Number) is not covered by your current insurance plan. This often happens with over-the-counter (OTC) medications even when prescribed.',
          solution: 'Review insurance denial to proceed',
    ...
    notes: 'Take one tablet daily as needed. Qty 30 tablets.',
  },
  {
    id: 'rx-006',
