...
export const prescriptions: Prescription[] = [
  ...
  // Insurance denied prescription for Lily Jenkins
  {
    id: 'rx-011',
    rxNumber: 'RX-4920400-01',
      ...
      coverageItems: [
        {
          ...
          denialDetails: 'Blue Cross denied coverage because the dependent (Lily) is over 21. If she is currently enrolled in full-time post-secondary education, you can restore coverage by submitting proof of her student status.',
          solution: 'Submit proof of full-time student enrollment to restore coverage',
          contactPhone: '1-800-123-4567',
        },
      ],
    },
    notes: 'Emergency allergy medication. Insurance denied coverage due to dependent age limit.',
  },
];
