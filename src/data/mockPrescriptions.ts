...
export const prescriptions: Prescription[] = [
  ...
  },
  {
    ...
    quantity: 180,
    dosage: '500mg',
    frequency: 'Take 1 tablet twice daily',
    ...
    financials: {
      totalCost: 75.00,
      insuranceCoverage: 71.25,
      copay: 3.75,
      deductible: 0,
      coverageReason: 'Blue Cross (70%) + Secondary Coverage (25%)',
      coverageItems: [
        { provider: 'Blue Cross', percentage: 70, amount: 52.50 },
        { provider: 'Secondary Coverage', percentage: 25, amount: 18.75 },
      ],
    },
    pickupInfo: {
      estimatedReadyTime: '2025-12-16T13:00:00Z',
      lockerNumber: 'A-15',
      orderNumber: '38475-E',
    },
  ...
  },
  {
    ...
    financials: {
      ...
      coverageReason: 'Blue Cross (100%)',
      coverageItems: [
        { provider: 'Blue Cross', percentage: 100, amount: 10.00 },
      ],
    },
  ...
  },
  {
    ...
    financials: {
      ...
      coverageReason: 'Blue Cross (75%) + Sunlife (25%)',
      coverageItems: [
        { provider: 'Blue Cross', percentage: 75, amount: 22.50 },
        { provider: 'Sunlife', percentage: 25, amount: 7.50 },
      ],
    },
  ...
  },
  {
    ...
    financials: {
      ...
      coverageReason: 'Blue Cross (100%)',
      coverageItems: [
        { provider: 'Blue Cross', percentage: 100, amount: 25.00 },
      ],
    },
  ...
  // Insurance denied prescription for Lily Jenkins - Vyvanse
  {
    id: 'rx-011',
    rxNumber: '#4920391-01',
    ...
    pharmacy: pharmacies['medkey-main'],
    datePrescribed: '2026-03-16',
    dateExpires: '2026-12-20',
    lastPickedUp: '2026-02-16',
    refillsAllowed: 3,
    refillsRemaining: 2,
    insurance: jenkinsInsurance,
    financials: {
      ...
      coverageItems: [
        {
          ...
          amount: 0.00,
          isDenied: true,
          denialReason: 'Coverage Denied',
          denialDetails: 'Blue Cross denied coverage because the dependent is over 21. If she is currently enrolled in full-time post-secondary education, you can restore coverage by submitting proof of her student status.',
          solution: 'Submit proof of student status to restore coverage',
